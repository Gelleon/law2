  ...
  const services = [
    {
      ...
      features: ['Предварительное следствие и дознание', 'Судебное разбирательство во всех инстанциях', 'Обжалование действий и бездействий правоохранительных органов', 'Защита прав потерпевших'],
    ...
    },
    {
      ...
      features: ['Споры об установлении границ', 'Споры о праве собственности, аренды на земельные участки', 'Исправление кадастровой ошибки', 'Узаконивание, снос самовольных строений'],
    ...
    },
    {
      ...
      features: ['Банкротство физических лиц', 'Банкротство юридических лиц и индивидуальных предпринимателей', 'Защита имущественных прав доверителей при банкротстве', 'Списание долгов'],
    ...
    },
    {
      ...
      features: ['Восстановление срока принятия наследства', 'Установление родства и нахождения на иждивении', 'Увеличение и уменьшение наследственной массы', 'Споры о праве собственности на наследство'],

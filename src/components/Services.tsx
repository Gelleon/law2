  ...
  const services = [
    {
      ...
      features: ['Предварительное следствие и дознание', 'Судебное разбирательство во всех инстанциях', 'Обжалование действий и бездействий правоохранительных органов', 'Защита потерпевших'],

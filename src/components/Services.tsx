...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['Банкротство физических лиц', 'Банкротство юридических лиц и индивидуальных предпринимателей', 'Защита имущественных прав доверителей при банкротстве', 'Защита от банкротства'],
